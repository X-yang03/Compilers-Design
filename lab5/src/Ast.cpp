...
void BinaryExpr::genCode()
{
    ...
    if (op == AND)
    {
        ...
        if(inIf){
            ...
            new CondBrInstruction(trueBB, if_false_BB, expr1->getOperand(), bb);
        }
    ...
    else if(op == OR)
    {
        ...
        if(inIf){
            ...
            new CondBrInstruction(if_true_BB,falseBB, expr1->getOperand(), bb);
    ...
    else if(op >= LESS && op <=NEQ)  //LESS,LE,GREATER,GE,EQ,NEQ
    {
        ...
        if(genBr > 0){
            ...
            // new CondBrInstruction(trueBlock, falseBlock, dst, bb);
            // new UncondBrInstruction(mergeBlock, falseBlock);
            // true_list.push_back(&trueBlock);
            // false_list.push_back(&falseBlock);
